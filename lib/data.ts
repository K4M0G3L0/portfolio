...
export const SYSTEMS = [
  {
    ...
    metrics: { days: 6, commits: 24, modules: 8 },
  },
  {
    id: "bloomos",
    name: "BloomOS",
  ...
  },
  {
    ...
    description: "Execution intelligence layer. Coordinates suppliers, tracks delivery proof with SHA-256 document hashing, monitors project cashflow against tender payment schedules.",
    status: "building",
    statusLabel: "Day 7 — Next",
    color: "#06B6D4",
    tech: ["Supply Chain AI", "Proof of Service", "Hash Verification", "Financial Tracking"],
    github: "https://github.com/K4M0G3L0/luma-aios",
  },
  {
    id: "buildos",
...
export const BUILD_TIMELINE = [
  ...
  { day: 7, module: "Flowlink Handoff", status: "building", description: "BloomOS → Flowlink integration when tender is won" },
  { day: 14, module: "MoneyOS", status: "planned", description: "Financial intelligence, invoice management, cashflow analysis" },
