...
export const BUILD_TIMELINE = [
  ...
  { day: 9, module: "MoneyOS", status: "complete", description: "VAT-compliant invoice engine, 13-week cashflow forecasting, margin tracking, financial risk monitor - 8/8 tests passing" },{ day: 10, module: "BuildOS", status: "complete", description: "29-activity programme engine, critical path calculation, CIDB compliance monitoring, AI delay prediction, Build Agent copilot, digital twin - 8/8 tests passing" },{ day: 11, module: "CapitalOS", status: "building", description: "Capital intelligence: invoice financing, working capital, funding strategy, equity vs debt analysis" },
